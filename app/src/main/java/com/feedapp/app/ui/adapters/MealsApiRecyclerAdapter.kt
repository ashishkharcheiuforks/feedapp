...
class MealsApiRecyclerAdapter(
    val context: Context,
    private val searchMealsCallback: SearchMealsCallback
    ...
    override fun onBindViewHolder(holder: MealApiViewHolder, position: Int) {
        ...
        holder.mainLayout.setOnClickListener {
            if (searchMealsCallback.isConnected()) {
    ...
    private fun startDetailedActivity(food: FoodApiModel) {
        searchMealsCallback.startDetailedActivity(ConnectionMode.ONLINE, null, food)
    }
