...
import com.feedapp.app.data.interfaces.SearchMealsCallback
...
class SearchActivity @Inject constructor() : ClassicActivity(), SearchMealsCallback,
    RecentProductsAdapterCallback {
    @Inject
    ...
    //    private var dateString: Day? = null
    ...
    override fun onBackPressed() {
        if (viewModel.hasSearched.value == true) {
            viewModel.hasSearched.postValue(false)
        } else finish()
    }
    ...
    private fun subscribeObservers() {
        ...
        connectionLiveData.observe(this, Observer {
            it?.let {
                viewModel.isConnected.value = it.isConnected
            }
        })
        ...
        viewModel.observeRecipe().observe(this, Observer {
            viewModel.mealsOnline.postValue(it)
        })
