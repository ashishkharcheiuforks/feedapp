...
import com.feedapp.app.data.interfaces.StatisticsProductDeletionCallback
...
class StatisticsDayFragment : DaggerFragment(), StatisticsProductDeletionCallback {
    ...
    private fun onDeletionCallback() {
