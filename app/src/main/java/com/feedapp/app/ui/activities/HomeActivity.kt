...
class HomeActivity : ClassicActivity(), BottomNavigationValuesUpdate {
    ...
    override fun checkReturnedFromSettings() {
        // if returned from settings tab, update values
        if (viewModel.currentBottomPosition.value == FragmentNavigationType.SETTINGS) {
